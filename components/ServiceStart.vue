          ...
          <div class="pbmit-ele-header-area">
            <div class="pbmit-heading-subheading">
              ...
              <div class="pbmit-heading-desc">
                A house visit involves a healthcare provider, such as a doctor,
                traveling to a patient's residence to deliver medical treatment.
              </div>
            </div>
            <NuxtLink class="pbmit-btn" to="about_us">
